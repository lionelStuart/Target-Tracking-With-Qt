...
CMHI::CMHI():MHI_DURATION(1),MAX_TIME_DELTA(0.5),MIN_TIME_DELTA(0.05),N(4)
{
	// MHI_DURATION = 1;
	 //MAX_TIME_DELTA = 0.5;
	//MIN_TIME_DELTA = 0.05;
	...
	segmask = 0; // motion segmentation map
...
void CMHI::  update_mhi( IplImage* img, IplImage* dst, int diff_threshold )
{
